...
- [Passive Mouse Tracking — Mode 2029](/docs/decset/mode2029-passive-mouse) — Mouse tracking while retaining user text selection
- [Text Selection Tracking — Mode 2030](/docs/decset/mode2030-text-selection) — Forwarding user text selections to host app
